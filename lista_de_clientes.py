...
class MainWindow(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.header = [qApp.tr('Código'), qApp.tr('Nome'), qApp.tr('Endereço'), qApp.tr('NUIT'), qApp.tr('Email'),
                       "Contactos", "Perc. Desconto", "Valor Mínimo"]
    ...
    def fill_table(self):
        ...
        self.sql = """select cod, nome, endereco, NUIT, email, contactos, desconto, valor_minimo  
        from clientes where nome like "%{nome}%" """.format(nome=self.find_w.text())
